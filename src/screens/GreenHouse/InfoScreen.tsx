...
import { Dimensions, Image, SafeAreaView, StyleProp, StyleSheet, Text, View, ViewStyle } from "react-native";
            ...
            <View style = {styles.item}>
                <View style = {styles.box}>
                    <View style = {styles.devicebox}>
                        ...
                        <Image style= {styles.deviceimage} source={require("../../components/UI/swap.png")}></Image>
                ...
                <View style = {styles.box}>
                    <View style = {styles.devicebox}>
                        ...
                        <Image style = {styles.sensorimage} source={require("../../components/UI/temperature.png")}></Image>
